...
$(document).ready(function () {
    ...
    if ($("#morris_extra_line_chart").length > 0)
        Morris.Line({
            ...
            fillOpacity: 0.5,
            lineWidth: 2,
            pointStrokeColors: ["#0f75bc", "#e2e2e2", "#bdbdbd"],
            behaveLikeLine: true,
            grid: true,
            gridLineColor: "#eee",
            hideHover: "auto",
            lineColors: ["#0f75bc", "#e2e2e2", "#bdbdbd"],
            resize: true,
    ...
    if ($("#morris_area_chart").length > 0)
        ...
        Morris.Area({
            ...
            lineWidth: 0,
            fillOpacity: 1,
            pointStrokeColors: ["#0f75bc", "#ababab", "#cecece"],
            behaveLikeLine: true,
            grid: true,
            gridLineColor: "#eee",
            hideHover: "auto",
            lineColors: ["#0f75bc", "#ababab", "#cecece"],
            resize: true,
            redraw: true,
            smooth: true,
            gridTextColor: "#878787",
