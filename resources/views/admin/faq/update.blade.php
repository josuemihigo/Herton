                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="/faqs">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="reponse" value="{{ $faqs->reponse }}"/>
                                            </div>
                                            <div class="form-group">
                                                <label for="my-select">Categorie de faq</label>
                                                <select id="my-select" class="form-control" name="categorie" >
                                                        @foreach ($categories as $key)
                                                            @if ($faqs->reponse==$key->desc_id)
                                                            <option value="{{ $key->descfaq_id }}" selected="">{{ $key->description }}</option>
                                                            @endif
