             ...
             <div class="container">
                 ...
                 <div class="row">
                    ...
                    <section class="hk-sec-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <form class="needs-validation" action="/Contacts" method="POST">
                                    @csrf
                                    <div class="form-row">
                                        <div class="col-md-8 mb-15">
                                            ...
                                            <div class="input-group">
                                                ...
                                                @enderror "  name="adresse" placeholder="Adresse complet" aria-describedby="validationTooltipUsernamePrepend" required>
                                               @error('adresse')
                                     ...
                                     <div class="col-md-8 mb-15">
                                            ...
                                            <input type="mail" class="form-control" id="validationTooltip03" name="mail"  placeholder="aaaaaa@gggg.cd" required>
                                            @error('mail')
                                            <div class="invalid-tooltip">
                                                {{ $errors->first('mail') }}
                                            </div>
                                        ...
                                        <div class="col-md-8 mb-15">
                                            ...
                                            <input type="text" class="form-control" id="cc-number"  data-mask="999-999-999" name="telephone"  placeholder="State" required>
                                            @error('telephone')
                                            <div class="invalid-tooltip">
